...
const routes = [
    ...
    { path: 'inicio', loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_inicio_inicio_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/inicio/inicio.module */ 83633)).then(m => m.InicioPageModule)
    },
    {
        path: 'clases',
    ...
    {
        path: 'horarios',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_horarios_horarios_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/horarios/horarios.module */ 76209)).then(m => m.HorariosPageModule)
    },
    {
        path: 'mis-reservas',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_mis-reservas_mis-reservas_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/mis-reservas/mis-reservas.module */ 8401)).then(m => m.MisReservasPageModule)
    },
    {
        path: 'mis-resultados',
...
let MenuComponent = class MenuComponent {
    constructor(menu, route, service) {
        this.menu = menu;
        this.route = route;
